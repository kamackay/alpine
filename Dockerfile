...
# This is mostly copied from mhart's alpine-node, but with extra apks
RUN apk add --no-cache \
    curl make gcc g++ sudo \
...
RUN npm install --ignore-optional -g sass webpack webpack-cli yarn typescript prettier less
